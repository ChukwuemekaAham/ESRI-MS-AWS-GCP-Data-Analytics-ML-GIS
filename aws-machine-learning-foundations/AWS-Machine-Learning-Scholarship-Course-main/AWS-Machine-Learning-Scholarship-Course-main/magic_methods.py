...
class Gaussian():
    ...
    def __add__(self, other):
        ...
        result.mean = self.mean + other.mean # To calculate the mean of the sum of two Gaussian distributions
        result.stdev = math.sqrt(self.stdev ** 2 + other.stdev ** 2) # To calculate the standard deviation of the sum of two Gaussian distributions
