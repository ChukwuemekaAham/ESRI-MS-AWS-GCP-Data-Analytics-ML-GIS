...
#    
###
total = int(shirt_one.price + shirt_two.price)
print(total)
...
###
total_discount = round(shirt_one.discount(.14) + shirt_two.discount(.06))
# print('Total discount of shirt_one 14% & shirt_two 6% is equal to ' + str(total_discount))
