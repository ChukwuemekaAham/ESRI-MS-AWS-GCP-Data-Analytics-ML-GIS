...
This keeps memory usage low and ensures your pipeline remains efficient.
...
In this example, we’ll request data from an API that serves the **NYC taxi dataset**. For these purposes we 
created an API that can serve the data you are already familiar with.
